...
const supportRoutes = require('./routes/supportRoutes'); // Assuming you have support-related routes
const errorHandler = require('./middlewares/errorHandler');
const { generateDefaultTokens } = require('./middlewares/authMiddleware');
